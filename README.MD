...
- Integração do back-end com NestJS para melhor organização e padronização do código
- Maior validação no middleware por parte do Next.js (validação de URLs, IDs, UUIDs e demais parâmetros de entrada)
---
